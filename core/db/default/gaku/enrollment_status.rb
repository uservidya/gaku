...
statuses = [
  ...
  { code: 'transferred_in', name: 'Transfered In',
    name_ja: '転入', active: true },
  { code: 'transferred_out', name: 'Transfered Out',
    name_ja: '転出', active: false },
  { code: 'course_transfer_in', name: 'Course Transfer In',
    name_ja: '編入', active: true },
  { code: 'course_transfer_out', name: 'Course Transfer Out',
    name_ja:  '編出', active: false },
  { code: 'visiting',  name: 'Visiting',  name_ja: '留学', active: true },
  { code: 're_admitted', name: 'Re-Admitted',  name_ja: '再入学', active: true },
  { code: 'for_credit_exchange', name: 'For-Credit Exchange',
    name_ja: '単位認定留学', active: true },
  { code: 'non_credit_exchange', name: 'Non-Credit Exchange',
    name_ja: '休学留学', active: true },
  ...
  { code: 'terminal_leave', name: 'Terminal Leave',
    name_ja: '除籍', active: false },
  { code: 'on_leave', name: 'On Leave', name_ja: '一時自主退学', active: false },
  { code: 'extended_absence', name: 'Extended Absence',
    name_ja: '長期自主退学', active: false },
