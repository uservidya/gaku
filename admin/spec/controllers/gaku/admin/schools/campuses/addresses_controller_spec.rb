      ...
      describe 'JS PATCH #update' do
        context 'with valid attributes' do
          before do
            gaku_js_patch :update,
                          id: address, school_id: school.id,
                          campus_id: campus.id, address: attributes_for(:address, address1: 'test')
          end
        ...
        context 'with invalid attributes' do
          before do
            gaku_js_patch :update,
                          id: address, school_id: school.id,
                          campus_id: campus.id, address: attributes_for(:address, address1: '')
          end
